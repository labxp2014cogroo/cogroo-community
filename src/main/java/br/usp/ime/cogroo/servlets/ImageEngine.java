...
public class ImageEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		...
		new com.octo.captcha.component.word.wordgenerator.ComposeDictionaryWordGenerator(
				new com.octo.captcha.component.word.FileDictionary("jcaptcha"));

		// wordtoimage components
		TextPaster paster = new DecoratedRandomTextPaster(new Integer(6),
				new Integer(7), new SingleColorGenerator(Color.black),
		...
		BackgroundGenerator back = new UniColorBackgroundGenerator(new Integer(
				200), new Integer(100), Color.white);
		// BackgroundGenerator back = new FunkyBackgroundGenerator(new
		// Integer(200), new Integer(100));
	...
	protected void buildInitialFactories2() {
		 ...
		 */
		BackgroundGenerator back = new UniColorBackgroundGenerator(200, 70,
				Color.white);
		...
		FontGenerator shearedFont = new RandomFontGenerator(50, 50, new Font[] {
				...
				new Font("Credit valley", Font.BOLD, 50) }, false);
		...
		word2image = new DeformedComposedWordToImage(false, shearedFont, back,
		...
		this.addFactory(new com.octo.captcha.image.gimpy.GimpyFactory(
				dictionnaryWords, word2image, false));
